export interface Notification {
  id: string;
  type: 'pqr_nuevo' | 'encuesta_nueva' | 'cotizacion_aceptada' | 'cotizacion_rechazada' | 'terminos_aceptados' | 'diagnostico_completado' | 'reparacion_completada' | 'pedido_nuevo' | 'stock_bajo' | 'producto_agotado' | 'order_authorized' | 'warranty_info' | 'system_alert' | 'success' | 'error' | 'warning' | 'info';
  title: string;
  message: string;
  timestamp: Date;
  isRead: boolean;
